        ...
        <Col sm={8}>
          <div>
            <div className='header'>
              ...
              <h1 className='main-course-title'>{data[0]?.attributes?.title}</h1>
            ...
            <div className='blog-section'>
              <div className='left-side'>
                ...
                <Card className='blog-card' key={1}>
                  <CardMedia className='course-hero-img'
                    sx={{ height: 140 }}
                    image={`${img_url}${data[0]?.attributes?.blogimage?.data?.attributes?.url}`}
                    title="green iguana"
                  />
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      <p> {data[0]?.attributes?.blogcontent}</p>
                    </Typography>
                  </CardContent>
                </Card>
